...
JNotify.StdMsgTimeout = 10			-- can touch. default timeout if not specified
JNotify.TemplateXPos = 0.5    		-- can touch. x pos
JNotify.TemplateYPos = 0.02   		-- can touch. y pos
JNotify.TemplateFont = 4      		-- can touch. font type

function JNotify:Start()
...
function JNotify:DoNotify(msg, timer)
...
function JNotify:DrawTextTemplate(text,x,y,font,scale1,scale2,colour1,colour2,colour3,colour4,wrap1,wrap2,centre,outline,dropshadow1,dropshadow2,dropshadow3,dropshadow4,dropshadow5,edge1,edge2,edge3,edge4,edge5)
    return {
      text         =                    "",
      x            =                    -1,
      y            =                    -1,
